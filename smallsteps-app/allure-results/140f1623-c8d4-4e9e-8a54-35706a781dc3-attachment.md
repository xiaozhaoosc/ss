...
- Name: spec\parent-other-deep.spec.ts >> 设备配置和亲子契约页面测试 >> 亲子契约页面加载测试
- Location: tests\e2e\spec\parent-other-deep.spec.ts:41:7
