...
- Name: spec\parent-profile.spec.ts >> Parent Profile Tests >> Test settings navigation
- Location: tests\e2e\spec\parent-profile.spec.ts:46:7
...
Call log:
  - waiting for getByText('通知设置')
    - locator resolved to <span>通知设置</span>
