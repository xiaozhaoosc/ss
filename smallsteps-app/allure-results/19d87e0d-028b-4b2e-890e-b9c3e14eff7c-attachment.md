...
- Name: spec\parent-emotion-deep.spec.ts >> 情绪相关页面深度测试 >> 情绪警报页面 - Mark as Read 按钮点击
- Location: tests\e2e\spec\parent-emotion-deep.spec.ts:33:7
...
Call log:
  - waiting for locator('button:has-text("Mark as Read")')
