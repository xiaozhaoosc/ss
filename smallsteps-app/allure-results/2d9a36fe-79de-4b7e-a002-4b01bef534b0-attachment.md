...
- Name: template.spec.ts >> ADHD 模板库 E2E 测试 >> 能够访问模板库列表页
- Location: tests\e2e\template.spec.ts:5:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:9091/#/pages/template/library
Call log:
  - navigating to "http://localhost:9091/#/pages/template/library", waiting until "load"
