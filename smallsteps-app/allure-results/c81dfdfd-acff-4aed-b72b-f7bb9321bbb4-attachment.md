...
Locator: locator('text=ADHD 模板库').or(locator('.min-h-screen'))
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=ADHD 模板库').or(locator('.min-h-screen'))
...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e54]:
    - strong [ref=e56]: 系统提示
    - generic [ref=e57]: No endpoint GET /ssapi/template/list.
