...
```
Error: locator.click: Error: strict mode violation: getByText('我的') resolved to 2 elements:
    1) <span>我的</span> aka locator('uni-page-body').getByText('我的')
    2) <div class="uni-tabbar__label">我的</div> aka locator('uni-tabbar').getByText('我的')
...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e190]:
    ...
    - generic [ref=e193]: "Handler dispatch failed: java.lang.BootstrapMethodError: bootstrap method initialization exception"
