...
- Name: spec\parent-other-deep.spec.ts >> 设备配置和亲子契约页面测试 >> 亲子契约页面 - 活跃契约区域
- Location: tests\e2e\spec\parent-other-deep.spec.ts:70:7
