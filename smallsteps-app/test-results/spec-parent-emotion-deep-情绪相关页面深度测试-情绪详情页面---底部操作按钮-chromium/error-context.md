...
- Name: spec\parent-emotion-deep.spec.ts >> 情绪相关页面深度测试 >> 情绪详情页面 - 底部操作按钮
- Location: tests\e2e\spec\parent-emotion-deep.spec.ts:86:7
