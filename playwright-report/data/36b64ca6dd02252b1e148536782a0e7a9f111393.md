...
- Name: reward_redemption.spec.ts >> Reward Redemption E2E >> Child can redeem a reward successfully
- Location: tests\e2e\reward_redemption.spec.ts:8:7
...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e52]:
    - strong [ref=e54]: 系统提示
    - generic [ref=e55]: "### Error querying database. Cause: org.apache.ibatis.reflection.ReflectionException: Error instantiating class com.kenzhao.smallsteps.common.ss.domain.Child with invalid types () or values (). Cause: java.lang.reflect.InvocationTargetException ### The error may exist in com/kenzhao/smallsteps/child/mapper/ChildMapper.java (best guess) ### The error may involve com.kenzhao.smallsteps.child.mapper.ChildMapper.selectById ### The error occurred while handling results ### SQL: SELECT id,parent_id,nickname,birthday,gender,avatar_url,star_balance,total_stars,level,del_flag FROM ss_child WHERE id=? AND del_flag='0' ### Cause: org.apache.ibatis.reflection.ReflectionException: Error instantiating class com.kenzhao.smallsteps.common.ss.domain.Child with invalid types () or values (). Cause: java.lang.reflect.InvocationTargetException"
    - generic [ref=e57] [cursor=pointer]: 知道了
```
