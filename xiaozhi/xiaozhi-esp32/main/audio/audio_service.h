...
enum AudioTaskType {
    ...
    kAudioTaskTypeEncodeToOfflineQueue,
...
public:
    ...
    std::unique_ptr<AudioStreamPacket> PopPacketFromOfflineQueue();
...
private:
    ...
    std::deque<std::unique_ptr<AudioStreamPacket>> audio_offline_queue_;
