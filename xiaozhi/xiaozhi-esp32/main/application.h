...
public:
    ...
    // 蓝牙手动选择控制
    void SelectNextBluetoothDevice();
    void SelectPreviousBluetoothDevice();
    void ConnectSelectedBluetoothDevice();
...
private:
    ...
    // 蓝牙列表选择
    std::vector<BluetoothDevice> manual_scan_results_;
    int manual_scan_index_ = 0;
    ...
    void UpdateBluetoothDeviceListDisplay();
