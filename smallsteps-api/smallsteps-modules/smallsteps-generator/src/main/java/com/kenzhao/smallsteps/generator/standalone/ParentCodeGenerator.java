...
public class ParentCodeGenerator {
    ...
    private static void createTables(Connection conn) throws SQLException {
        String[] sqls = {
            "CREATE TABLE IF NOT EXISTS ss_parent_task (task_id bigint NOT NULL, user_id bigint DEFAULT NULL, title varchar(100) DEFAULT '', description varchar(500) DEFAULT '', icon varchar(100) DEFAULT '', difficulty integer DEFAULT 1, reward_points integer DEFAULT 10, status char(1) DEFAULT '0', create_by bigint DEFAULT NULL, create_time timestamp DEFAULT NULL, update_by bigint DEFAULT NULL, update_time timestamp DEFAULT NULL, del_flag char(1) DEFAULT '0', PRIMARY KEY (task_id))",
